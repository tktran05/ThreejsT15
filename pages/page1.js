...
export function House(){
    ...
    // sàn phụ tầng 2
    const a5 = HCN(65, 2, 100 , 130, 75, -93, 0x79888a) // sàn tầng 2.1
    group.add(a5)

    const a6 = HCN(65, 2, 100 , -130, 75, -93, 0x79888a) // sàn tầng 2.2
    group.add(a6)
